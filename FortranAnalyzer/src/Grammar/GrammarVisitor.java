...
public interface GrammarVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitCont(GrammarParser.ContContext ctx);
	/**
	 * Visit a parse tree produced by the {@code bre}
	 * labeled alternative in {@link GrammarParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBre(GrammarParser.BreContext ctx);
	/**
	 * Visit a parse tree produced by the {@code dynamic1}
	 * labeled alternative in {@link GrammarParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDynamic1(GrammarParser.Dynamic1Context ctx);
	/**
	 * Visit a parse tree produced by the {@code allo}
	 * labeled alternative in {@link GrammarParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAllo(GrammarParser.AlloContext ctx);
	/**
	 * Visit a parse tree produced by the {@code deall}
	 * labeled alternative in {@link GrammarParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeall(GrammarParser.DeallContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code exprFunctionReturn}
	 * labeled alternative in {@link GrammarParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprFunctionReturn(GrammarParser.ExprFunctionReturnContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ngative}
	 * labeled alternative in {@link GrammarParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNgative(GrammarParser.NgativeContext ctx);
	/**
	 ...
	 * labeled alternative in {@link GrammarParser#programStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMainStatement(GrammarParser.MainStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GrammarParser#continue_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContinue_(GrammarParser.Continue_Context ctx);
	/**
	 * Visit a parse tree produced by {@link GrammarParser#break_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBreak_(GrammarParser.Break_Context ctx);
	/**
	 * Visit a parse tree produced by the {@code oneDynamic}
	 * labeled alternative in {@link GrammarParser#dynamicArrayDec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOneDynamic(GrammarParser.OneDynamicContext ctx);
	/**
	 * Visit a parse tree produced by the {@code twoDynamic}
	 * labeled alternative in {@link GrammarParser#dynamicArrayDec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTwoDynamic(GrammarParser.TwoDynamicContext ctx);
	/**
	 * Visit a parse tree produced by the {@code oneAllocate}
	 * labeled alternative in {@link GrammarParser#allocate}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOneAllocate(GrammarParser.OneAllocateContext ctx);
	/**
	 * Visit a parse tree produced by the {@code twoAllocate}
	 * labeled alternative in {@link GrammarParser#allocate}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTwoAllocate(GrammarParser.TwoAllocateContext ctx);
	/**
	 * Visit a parse tree produced by {@link GrammarParser#deallocate}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
